...
export default function TerminalHero() {
  return (
    <section className="relative min-h-screen bg-[#0a1628] pt-32 pb-20 px-4 overflow-hidden flex items-center">
      {/* Base gradient - not flat */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0d1f3a] via-[#0a1628] to-[#070f1d]" />
      
      {/* Ambient glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-[#D4AF37]/[0.035] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-20 right-1/4 w-96 h-96 bg-[#D4AF37]/[0.05] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-32 left-1/4 w-[500px] h-[500px] bg-emerald-500/[0.025] rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.08] mb-8 tracking-tight">
              Business systems<br />
              that actually<br />
              <span className="text-[#D4AF37] drop-shadow-[0_0_40px_rgba(212,175,55,0.25)] font-script text-6xl md:text-7xl lg:text-8xl">
                make sense.
              </span>
            </h1>
