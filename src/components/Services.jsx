...
import { FiZap, FiCode, FiSmartphone, FiFileText, FiTrendingUp, FiShield, FiShoppingCart } from 'react-icons/fi'
...
export default function Services() {
  const services = [
    { title: 'Google Apps Script', description: 'Custom automation solutions built specifically for your workflow. This is what I do best.', icon: FiCode,
      ...
      <div className="container-max px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}
          ...
          <p className="text-xl text-navy-600 max-w-2xl mx-auto mt-6">
            From custom Google Apps Script automation to daily admin — I build systems that grow with you
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-white/70 max-w-lg mx-auto mb-8">
            Explore AbilitySuite™ — 12 professional Google Sheets templates that automate invoicing, 
